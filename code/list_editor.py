...
import sci_corpus.ui.list_editor_dlg as listEditor
import sci_corpus.icons.sci_corpus_rc
...
class ListEditor(QDialog):
    ...
    def __init__(self, name,  list, parent = None):
        ...
        self.ui.listWidget.itemDoubleClicked.connect(self.openPersistentEditorItem)
    ...
    def add(self):
        self.ui.listWidget.insertItem(self.ui.listWidget.currentRow()+1, QListWidgetItem('New'))
