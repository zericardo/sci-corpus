...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBoxAutoOpen = QtGui.QCheckBox(Dialog)
        self.checkBoxAutoOpen.setChecked(True)
        self.checkBoxAutoOpen.setObjectName("checkBoxAutoOpen")
        self.gridLayout.addWidget(self.checkBoxAutoOpen, 3, 4, 1, 1)
        self.lineEditPath = QtGui.QLineEdit(Dialog)
        self.lineEditPath.setObjectName("lineEditPath")
        self.gridLayout.addWidget(self.lineEditPath, 3, 1, 1, 1)
        self.textEditDescription = QtGui.QTextEdit(Dialog)
        self.textEditDescription.setObjectName("textEditDescription")
        self.gridLayout.addWidget(self.textEditDescription, 2, 1, 1, 4)
        self.lineEditAuthor = QtGui.QLineEdit(Dialog)
        self.lineEditAuthor.setObjectName("lineEditAuthor")
        self.gridLayout.addWidget(self.lineEditAuthor, 1, 1, 1, 4)
        self.lineEditTitle = QtGui.QLineEdit(Dialog)
        self.lineEditTitle.setObjectName("lineEditTitle")
        self.gridLayout.addWidget(self.lineEditTitle, 0, 1, 1, 4)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBoxAutoOpen.setText(QtGui.QApplication.translate("Dialog", "Open after create", None, QtGui.QApplication.UnicodeUTF8))
